...
<head>
    ...
    <style>
        ...
        .contenedor-factura .text-center.mb-4 { margin-bottom: 0.08in !important; }
        .contenedor-factura h1 { font-size: 12px !important; line-height: 1.15; }
        .contenedor-factura h2 { font-size: 11px !important; padding: 3px 0 !important; margin-top: 0.06in !important; }
        .contenedor-factura p { font-size: 9px !important; }
        .contenedor-factura table { font-size: 10px !important; margin-bottom: 0.08in !important; }
        .contenedor-factura td { padding: 2px 4px !important; }
        .contenedor-factura .grid {
            display: grid !important;
            grid-template-columns: 2fr 1fr !important;
            gap: 0.07in !important;
            margin-bottom: 0.08in !important;
        }
        .contenedor-factura .md\:col-span-8,
        .contenedor-factura .md\:col-span-4 {
